        ...
        <div style="vertical-align:text-top;text-align:center">
            <div style="display:inline-block;width:65%">
                <form action="databaseProcessing.php" id='stockForm' method='POST' onSubmit="return confirmation();">
                    <input type='hidden' name='function' value='manualModifyStock'>
                    ...
                    <table style="min-width:0;">
                        ...
                        <?php 
                            $rowFormat = "<tr>
                            <td>ITEM</td>
                            <td><input class='equipNum' id='ITEM' name='ITEM' type='number' min='0' value=0></td>
                    ...
                    <div style="text-align:right">
                        <input type='submit' class='searchButtonResult' value='<?php echo $action; ?>'>
                    </div>
                </form>
            </div>
        </div> 
